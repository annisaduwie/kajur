...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">MASUK SEBAGAI BENDAHARA</p>

      <form action="<?=base_url();?>LoginBendahara/index_get" method="GET">
        ...
        <div class="form-group has-feedback">
          <input type="text" class="form-control" name="usernameb" id="input_username" placeholder="Masukkan Username">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="password" class="form-control" name="passwordb" id="input_password" placeholder="Masukkan Password">
  ...
  <script type="text/javascript">
    ...
    function sign_in() {
      ...
      $.ajax({
        url : "<?php echo base_url();?>LoginBendahara/index_get",
        type: "GET",
