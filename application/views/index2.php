...
<body class="hold-transition skin-blue sidebar-mini">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url('index2.html')?>" class="logo" style="background-color: #7dcea0;">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-circle-o text-red"></i>Penambahan</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o text-yellow"></i>Penarikan</a></li>
          </ul>
        </li>
      </ul>
    </section>
